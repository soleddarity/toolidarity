...
{
    name: "Dudes Degen Flip Cup",
    description:
      "#MOST DEGEN PLACE around to flip your cups!",
    icon: "https://edd.degenflipcup.io/images/degenflipcup.png",
    twitter: "#",
    discord: "discord.gg/dudessol",
    website: "https://edd.degenflipcup.io/",
    category: "Multiflip",
    from: "#C7AE35",
    to: "#03C2BC",
  },
...
},
{
    name: "BloodPack",
    description:
      "4444 adorably ferocious werewolves, gather under the full moon 🌕, eagerly anticipating their next delectable feast. 🍖",
    icon: "https://pbs.twimg.com/profile_images/1634982075676737536/20RBF9p5_400x400.jpg",
    twitter: "https://twitter.com/Bloodpack_Sol",
    discord: "https://t.co/orT5S8kJMu",
    website: "https://www.subber.xyz/dudessol/giveaways/bloodpack-free-mint",
    category: "AllowList",
    from: "#1df7a3",
    to: "#6c77e3",
},
