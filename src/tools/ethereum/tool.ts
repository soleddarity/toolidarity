export const tools = [ 
  {
    ...
    },
    {
      ...
      icon: "https://cdn.icy.tools/images/social-logo.png",
      twitter: "https://twitter.com/icy_tools",
      discord: "https://icy.community/",
      website: "https://icy.tools/",
      category: "Aggregator,Analytics",
      from: "#96C6FF",
      to: "#1C334E",
    },
{
  ...
  export const discounts = [
{
    ...
    description:
      "Get the best generative pixel art for your NFT collection in GIF or PNG designed by Sans-Qui. -25% for our holders.",
