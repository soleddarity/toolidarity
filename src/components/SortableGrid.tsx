            ...
            <div key={_id} data-id={_id} className={props.filter.length > 1 ? "grid-square static" : "grid-square"} style={{
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex overflow-scroll items-center gap-2 hide-scrollbar">
                        ...
                        : item === "Raid2Earn"
                        ? "text-white bg-[#A90404]"
                        : item === "Customization"
                        ? "text-white bg-[#21A267]"
                        : item === "Claim SOL"
                        ? "text-white bg-[#E50000]"
                        : item === "Customization"
                        ? "text-white bg-[#21A267]"
                        : item === "Own-2-Earn"
                        ? "text-white bg-[#E56800]"
                        : item === "Role Gestion"
                        ? "text-white bg-[#5E00E5]"
                        : item === "Token Creation"
                        ? "text-white bg-[#89C508]"
                        : item === "Verification"
                        ? "text-white bg-[#3AB93B]"
                        : item === "Community"
                        ? "text-white bg-[#E878F0]"
                        : item === "Betting"
                        ? "text-white bg-[#7B11B7]"
                        : item === "Verification"
                        ? "text-white bg-[#3AB93B]"
                        : item === "WL Gestion"
                        ? "text-white bg-[#846089]"
                        : item === "Naming Service"
